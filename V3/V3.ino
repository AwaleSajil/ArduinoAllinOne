...
#define AMMONIA_PIN A3 //pin for Ammonia sensor
#define BULB_PIN 11
#define HEATER_PIN 9
#define FAN_PIN 8
...
//dataReceived[7]   ---> auto state bool 1 if auto state is on and 0 if manual
...
void getAmmoniadata()
{
  int data = analogRead(AMMONIA_PIN);
  //data manupulation here if any
...
//functions for using appliances
//1. LDR Light Control
    void light_Bulb(){
      if(dataReceived[7] == 1)
      {
